...
#import "accporderController.h"

@interface accporderController ()

@end

@implementation accporderController
...
- (void)viewDidLoad {
    ...
    [userAddressLeftBack addTarget:self action:@selector(accpBlackFunc:) forControlEvents:UIControlEventTouchUpInside];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row == 6) {
        ...
        [orderfuncbut setTitle:@" 请点击确认接单 " forState:UIControlStateNormal];
        ...
        [orderfuncbut addTarget:self action:@selector(querenfunc:) forControlEvents:UIControlEventTouchUpInside];
...
//确认接单
-(void)querenfunc:(id)sender{

       UIAlertController *alertCon = [UIAlertController alertControllerWithTitle:@"温馨提示" message:@"确认接单后其他服务人员就无法接单了哦！接单后请在服务计时后开始工作" preferredStyle:UIAlertControllerStyleAlert];
